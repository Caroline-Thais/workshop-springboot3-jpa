...
import com.projetospring.projetospring.entities.Payment;
import com.projetospring.projetospring.entities.Product;
import com.projetospring.projetospring.entities.User;
import com.projetospring.projetospring.entities.enums.OrderStatus;
import com.projetospring.projetospring.repositories.CategoryRepository;
import com.projetospring.projetospring.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(null, "The Lord of the Rings", "Lorem ipsum dolor sit amet, consectetur.", 90.5, ""); new Product(null, "Smart TV", "Nulla eu imperdiet purus. Maecenas ante.", 2190.0, "");
